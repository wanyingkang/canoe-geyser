...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "snap-mods"
  WORKING_DIRECTORY "/home/wanying/canoe/geyser/_deps/athenapp-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("snap-mods" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/snap-mods")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/wanying/canoe/geyser/_deps/athenapp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/wanying/canoe/geyser/_deps/athenapp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
